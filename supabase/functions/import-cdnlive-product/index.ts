...
const PRODUCTS: Record<string, ProductCfg> = {
  ...
  'glass-po-compacto': {
    productName: 'Pó Compacto Glass – Ruby Rose',
    productSku: 'HB8631-FAM',
    slugBase: 'po-compacto-glass-ruby-rose',
    storagePrefix: 'glass-po-compacto',
    retailPrice: 6.99,
    costPrice: 1,
    variants: [
      { shade: 'GPF10', sku: 'HB8631', url: `${RR}/3529-po-compacto-gpf10-glass-hb8631-rubyrose` },
      { shade: 'GPF20', sku: 'HB8632', url: `${RR}/3532-po-compacto-gpf20-glass-hb8632-rubyrose` },
      { shade: 'GPL10', sku: 'HB8633', url: `${RR}/3533-po-compacto-gpl10-glass-hb8633-rubyrose` },
      { shade: 'GPL20', sku: 'HB8634', url: `${RR}/3534-po-compacto-gpl20-glass-hb8634-rubyrose` },
      { shade: 'GPM10', sku: 'HB8635', url: `${RR}/3535-po-compacto-gpm10-glass-hb8635-rubyrose` },
      { shade: 'GPM20', sku: 'HB8636', url: `${RR}/3536-po-compacto-gpm20-glass-hb8636-rubyrose` },
      { shade: 'GPM30', sku: 'HB8637', url: `${RR}/3537-po-compacto-gpm30-glass-hb8637-rubyrose` },
      { shade: 'GPT10', sku: 'HB8638', url: `${RR}/3538-po-compacto-gpt10-glass-hb8638-rubyrose` },
      { shade: 'GPT20', sku: 'HB8639', url: `${RR}/3539-po-compacto-gpt20-glass-hb8639-rubyrose` },
      { shade: 'GPD10', sku: 'HB86310', url: `${RR}/3530-po-compacto-gpd10-glass-hb86310-rubyrose` },
      { shade: 'GPD20', sku: 'HB86311', url: `${RR}/3528-po-compacto-gpd20-glass-hb86311-rubyrose` },
      { shade: 'GPD30', sku: 'HB86312', url: `${RR}/3531-po-compacto-gpd30-glass-hb86312-rubyrose` },
    ],
  },
  'glass-po-solto': {
    productName: 'Pó Solto Glass – Ruby Rose',
    productSku: 'HB8621-FAM',
    slugBase: 'po-solto-glass-ruby-rose',
    storagePrefix: 'glass-po-solto',
    retailPrice: 6.99,
    costPrice: 1,
    variants: [
      { shade: 'GPF01', sku: 'HB8621', url: `${RR}/3488-po-solto-gpf01-glass-hb8621-rubyrose` },
      { shade: 'GPL02', sku: 'HB8622', url: `${RR}/3489-po-solto-gpl02-glass-hb8622-rubyrose` },
      { shade: 'GPM03', sku: 'HB8623', url: `${RR}/3490-po-solto-gpm03-glass-hb8623-rubyrose` },
      { shade: 'GPT04', sku: 'HB8624', url: `${RR}/3491-po-solto-gpt04-glass-hb8624-rubyrose` },
    ],
  },
  'glass-bronzer': {
    productName: 'Bronzer e Iluminador Marmorizado Glass – Ruby Rose',
    productSku: 'HBF1605-FAM',
    slugBase: 'bronzer-iluminador-marmorizado-glass-ruby-rose',
    storagePrefix: 'glass-bronzer',
    retailPrice: 1,
    costPrice: 1,
    variants: [
      { shade: 'Tom 01', sku: 'HBF16051', url: `${RR}/3527-bronzer-e-iluminador-marmorizado-hbf16051-glass-rubyrose` },
      { shade: 'Tom 02', sku: 'HBF16052', url: `${RR}/3526-bronzer-e-iluminador-marmorizado-hbf16052-glass-rubyrose` },
    ],
  },
  'gel-game-on': {
